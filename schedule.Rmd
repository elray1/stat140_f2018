 ...
 * **In class**, we will work on:
    ...
    * More about hypothesis tests for a population proportion. [pdf](materials/20181001_proportion_h_test/20181001_proportion_h_test.pdf)
 * **After class**, please:
    * **Homework 5** due Wednesday, Oct 3
 ...
 * **In class**, we will work on:
    ...
    * Lab 07 on Gryd: thinking about hypothesis tests and confidence intervals
 * **After class**, please:
    * Start reviewing for our first midterm

#### Fri, Oct 5
 * **In class**, we will work on:
    * Lab 08 on Gryd: More practice with hypothesis tests and confidence intervals
 * **After class**, please:
