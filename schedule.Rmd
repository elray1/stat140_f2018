...
#### Mon, Sep 10
 * **In class**, we will work on:
    * Wrap-up of lab from Friday; things to know about R so far.
    * Material from Chapter 2 and related R functionality:
        * Worked example as a class of finding Joint, Marginal, and Conditional distributions based on a sample; Independence.
 ...
 * **In class**, we will work on:
    * Material from Chapters 3 and 4 and related R functionality:
        * Brief recap of data visualization with ggplot2
 ...
 * **In class**, we will work on:
    * Material from Chapters 3 and 4 and related R functionality:
        * Brief recap of data summarization functions in dplyr
        * Finish a lab about data visualizations and calculating quantitative summaries of data
 * **After class**, please do the following:
    * **Read**:
    ...
    * Start on **Homework 3**: Assignment covering Chapters 1 -- 4, on Gryd, due Friday Sep 21.
"
  )
```
