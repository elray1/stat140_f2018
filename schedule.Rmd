...
#### Fri, Sep 28
 * **In class**, we will work on:
    * The binomial model and its use for hypothesis tests about a proportion. [pdf](materials/20180928_rvs_binomial/20180928_binomial.pdf)
    * Lab 06 on Gryd
 * **After class**, please:
    * **Homework 5** due Wednesday, Oct 3
"
 ...
 * **In class**, we will work on:
    ...
    * Wrap up lab 06 on Gryd (more time if needed)
