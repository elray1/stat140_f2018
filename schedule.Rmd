 ...
 * **In class**, we will work on:
    * More about visualization:
        * Understqnding and interpreting common types of plots
...
#### Mon, Sep 17
 * **In class**, we will work on:
    * Brief recap of all functionality related to reading in and summarizing data in R so far: [pdf](resources/data_loading_summarizing/data_loading_summarizing.pdf)
    * Overview of when to use mean/median, standard deviation/IQR.
    * Finish the whole Bechdel test lab
 * **After class**, please do the following:
    * **Read**:
