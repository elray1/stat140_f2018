...
```{r, echo = FALSE, results='asis'}
make_week_box("week8", TRUE, "Week 8: Oct 22 -- 26",
"
#### Mon, Oct 22
 * **In class**, we will work on:
...
```{r, echo = FALSE, results='asis'}
make_week_box("week9", TRUE, "Week 9: Oct 29 -- Nov 2",
"
#### Mon, Oct 29
 * **In class**, we will work on:
    * **Quiz** on inference for a population proportion
    * Finish Lab 13 on Gryd
...
#### Fri, Nov 2
 * **In class**, we will work on:
    * Additional ideas about hypothesis tests and confidence intervals
 * **After class**, please:
 ...
 * **In class**, we will work on:
    * Start on Linear Regression?  Or finish additional ideas about hypothesis tests and confidence intervals.
 * **After class**, please:
    * Work on **HW8, due Mon. Nov 12** (it's short)
...
#### Fri, Nov 16
 * **Midterm 2 in class today**: covers inference for a population mean and population proportion; Homeworks 6, 7, and 8
"
  )
```
