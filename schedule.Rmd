 ...
 * **In class**, we will work on:
    * Material from Chapters 3 and 4 and related R functionality:
        ...
        * Brief recap of all functionality realted to reading in and summarizing data in R so far: [pdf](resources/data_loading_summarizing/data_loading_summarizing.pdf)
        * Overview of when to use mean/median, standard deviation/IQR.
        * Finish lab about data visualizations and calculating quantitative summaries of data
 * **After class**, please do the following:
    * **Read**:
    ...
    * Start on **Homework 3**: Assignment covering Chapters 1 -- 4, on Gryd, due Wednesday Sep 19.
"
  )
```
