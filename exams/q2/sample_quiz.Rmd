...
\textbf{This is a sample quiz.  For the real quiz, I will use a different data set, but will pick roughly 2-3 of the questions that are below and adapt them to the new data set with minimal modification.  (We won't have time to ask all of these questions in the actual quiz, but you should know how to answer all of them.)}
